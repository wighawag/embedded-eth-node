 ...
 * `webevm/revm` SUBTRACTS it, because revm charges intrinsic gas
 ...
 * AT BOTH SIDES. The node runs Cancun; `webevm/revm` admits
 ...
 * ADDS it to the EXECUTION gas an engine reports, and `webevm/revm`
