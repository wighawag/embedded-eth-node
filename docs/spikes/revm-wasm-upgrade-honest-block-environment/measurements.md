...
**Conclusion, and what shipped:** the read path takes `disableBaseFee`, `disableBlockGasLimit` and `disableEip3607`, and deliberately does NOT take `disableBalanceCheck`. See the code site in `packages/embedded-eth-node/src/revm.ts` and decision 6 of `work/notes/observations/decisions-revm-wasm-upgrade-honest-block-environment-2026-08-02.md`.
