 ...
 * work even in principle. And the package's own `webevm/worker-entry`
 ...
 *
 * IMPORTED BY PACKAGE NAME (`webevm/worker-host`,
 * `webevm/revm`) and not by relative `src/` path, unlike every other
